...
The aim of this assignment is to meet your group members and begin interacting. Full marks will be allocated to the group by completing the tasks via the link below. Please try and be as efficient as possible in your writing (we are looking for short, sharp responses).

**Submission**

Moodle by **11.55pm, on Tuesday, 24 March**.

```{r}
#| output: asis
# Refresh helper-driven submission links from course_info.R during render.
