...
## Tutorial exercises (or on your own)
...
2. Walk through [IA_template.qmd](../week1/IA_template.qmd.zip). Make sure you understand the quarto (qmd) file structure and make sure you can knit the file successfully to pdf format.
...
5. Complete Exercises 1-4 from [Section 2.10 of the textbook](https://otexts.com/fpp3/graphics-exercises.html).
