...
* **Seminars**, 3pm-4pm Wednesday, [Building K Level 3, K321, CA_K_K321](https://www.monash.edu/__data/assets/pdf_file/0010/2658961/Caulfield-campus-map.pdf).
* **Lectorials**, 4pm-5pm Wednesday, [Building K Level 3, K321, CA_K_K321](https://www.monash.edu/__data/assets/pdf_file/0010/2658961/Caulfield-campus-map.pdf).

* **Tutorials**, 50 minutes in class per week.  
* **Lecture Recordings**: TBA, coming soon 🚒.
...
schedule |>
  transmute(
    ...
    Quiz = if_else(is.na(Quiz), Quiz, glue::glue("[{Quiz}]({QMoodle})")),
...
**Quizzes**: There will be weekly quizzes (11 in total) that will cover course content from the first hour of lectures each week. (Hence, attending lectures is important!). You will be required to complete 8 out of the 11 quizzes. There will be a bonus mark (3%) for completing all 11 quizzes.
The quizzes will be made available during the lecture. 
